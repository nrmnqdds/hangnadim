      ...
      >
        <div className="p-5 bg-orange-800 rounded-lg drop-shadow-lg flex flex-col items-center justify-center w-[30%]">
          ...
          <p className="text-orange-300 text-sm drop-shadow-lg">
            ...
            unit every time you resist the temptation to take {"shortcuts"} that
            might undermine the integrity of the final product
          </p>
        </div>
        <div className="p-5 bg-orange-800 rounded-lg drop-shadow-md flex flex-col items-center justify-center w-[30%]">
          ...
          <p className="text-orange-300 text-sm drop-shadow-lg">
            Bear true faith and allegiance to the Malaysia Constitution. A loyal
            Soldier is one who supports the leadership and stands up for fellow
            Soldiers. By wearing the uniform of the MALAYSIA Armed Forces you
            are expressing your loyalty. And by doing your share, you show your
        ...
        <div className="p-5 bg-orange-800 rounded-lg drop-shadow-md flex flex-col items-center justify-center w-[30%]">
          ...
          <p className="text-orange-300 text-sm drop-shadow-lg">
            ...
            your own. Selfless service is larger than just one person. In
            serving your country, you are doing your duty loyally without
        ...
        <div className="p-5 bg-orange-800 rounded-lg drop-shadow-md flex flex-col items-center justify-center w-[30%]">
          ...
          <p className="text-orange-300 text-sm drop-shadow-lg">
            ...
            ingredient with the Army value of respect, which results from
            knowing you have put forth your best effort. The Army is one team
            and each of us has something to contribute
          </p>
        </div>
        <div className="p-5 bg-orange-800 rounded-lg drop-shadow-md flex flex-col items-center justify-center w-[30%]">
          <h1 className="text-orange-200 text-xl drop-shadow-lg">INTEGRITY</h1>
          <p className="text-orange-300 text-sm drop-shadow-lg">
